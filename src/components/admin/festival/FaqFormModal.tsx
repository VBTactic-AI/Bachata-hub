...
export type FaqFormValue = { id: string; question: string; answer: string };
...
export function FaqFormModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const url = mode === "create" ? `/api/festivals/${festivalId}/faq` : `/api/festivals/${festivalId}/faq/${initial!.id}`;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-5" onClick={onClose} role="presentation">
      ...
      >
        <div className="border-b border-admin-border px-5 py-4">
          <h3 id="faq-form-title" className="m-0 text-[17px] font-extrabold text-night-text">
