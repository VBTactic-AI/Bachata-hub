...
export function FinalSettingsPanel({
  ...
  return (
    <div className="stack gap-2 mt-2">
      ...
      {format === "JUDGES_DANCE" && (
        <p className="hint-text m-0">
          Стадия 1: финалисты-Партнёры танцуют — судьи-Партнёрши физически партнёрят и оценивают отмеченные ниже критерии,
          судьи-Партнёры смотрят со стороны и оценивают остальные. Стадия 2 — наоборот.
        </p>
      )}
