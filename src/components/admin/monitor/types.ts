...
export type MonitorRound = {
  ...
  // Отдельная страница "Результаты этапов" (round-results/[divisionId]) —
  // тот же список "прошёл/не прошёл", что и в panels ниже, но по всем
  // этапам категории сразу и без остального Монитора (для SUPER_ADMIN/
  // EVENT_ADMIN, которым нужно быстро свериться, не листая заходы).
